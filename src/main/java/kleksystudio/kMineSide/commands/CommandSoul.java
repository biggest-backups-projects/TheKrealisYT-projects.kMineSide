...
public class CommandSoul implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender s, Command cmd, String label, String[] args) {
        if(s instanceof Player && !s.equals(null)) {
          /*  Player p = ((Player) s).getPlayer();
            ...
            p.teleport(new Location(Bukkit.getServer().getWorld(plugin.getConfig().getString("settings.worlds.spawn", "spawn")), 21.5, 54, 51, Float.parseFloat("-134,9"), 1)); */
            return true;
        }
